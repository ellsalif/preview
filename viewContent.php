...
if(!empty($_GET['Service_Content_Id']))
{
    $Service_Content_Id = checkInput($_GET['Service_Content_Id']);
		...
		$db = Database::connect();									   
	$statement = $db->prepare('SELECT service_content.Services_Id,service_content.Service_Content_label,service_content.Service_Content_Name, service_content.Service_Content_Params,
