...
$db = Database::connect();
$statement = $db->prepare('SELECT service_content.Service_Id, service_content.Service_Content_Id, service_content.Service_Content_label, service_content.Service_Content_Name,
                            service_content.Service_Content_Url, service_content.Pf
							FROM service_content
							WHERE  service_content.Service_Id = ?');
 ...
 <head>
    ...
    <body>
        ...
        <div class="container admin">
          <div class="row">
              <h1><a href="<?php echo 'EditConfg.php?Service_Id=' .$_GET['Service_Id'];?>" class="btn btn-success btn-lg"><span class="glyphicon glyphicon-download-alt"></span> Edit file config</a></h1>
